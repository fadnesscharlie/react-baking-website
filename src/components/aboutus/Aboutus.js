  ...
  return (
    <>
      ...
      <div className="backgroundMain">
        <h1>
          <strong>Software Developer, Massage Therapist, and Baker.</strong>
        </h1>
        <br />
        <br />
        <div className="bakerInfo wordText">
          ...
          school and not the "special" ones, the oh so good fuggy chocolate with
          that delicious crunch of walnuts in the middle. I really started to
          take off in 2017 when I first tried to make my first custom cake. We
          always start somewhere, and this is my start, the process to make a
          "cat" cake, but turned more into a wolf cake. The process was super
          fun, and I knew I could improve and how.
          <br />
          Fun fact: The ears stayed in place with toothpicks, although the
          toothpicks did not last long, and we had to sing just a little bit
          faster.
          <br />
          <br />
          <img
          ...
          first cake, I was so estatic. It was to a friend, and I told them to
          challenge me. And oh did they! They went all out with a Ube Cake with
          ...
          in baking, I wanted to find a new passion that incorporated everything
          that baking has challenged me but more. What better a career then
          having a challenge every day with a new task to solve and having to
          constantly improvise to solve the days task. From finishing my Coding
          BootCamp in 2022, I finally found my calling, it was as challenging as
          I thought it would be with all the excitment and knowledge that
          awaited.
          <br />
          <br />
          <img
          ...
          creation was all of my efforts based in one. And I got to celebrate my
          little sister's 18th Birthday all in one! So of course, we had to
          supply the best! Starting with a Chocolate Cake with Homemade
          Raspberry Filling and Swiss Meringue Buttercream with a frog theme! I
          got to make a frog theme along with them gathering around and feeding
          ...
          beginnings and endless problems to solve. And of course, with a lovely
          baked good by my side!
        </div>
      </div>
    </>
  );
